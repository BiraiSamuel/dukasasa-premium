  ...
  try {
    ...
    const [stkResp, checkoutResp] = await Promise.all([
      collection.mpesaStkPush({
        ...
        host: "https://jezkimpremium.dukasasa.co.ke",
        api_ref: reference,
      }),
      collection.charge({
        first_name: firstName,
        ...
        host: "https://jezkimpremium.dukasasa.co.ke",
        api_ref: reference,
        redirect_url: "https://jezkimpremium.dukasasa.co.ke/receipt",
        callback_url: "https://jezkimpremium.dukasasa.co.ke/api/intasend/callback",
      }),
    ]);
